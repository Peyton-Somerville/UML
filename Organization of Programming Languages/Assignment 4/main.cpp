...
int main(int argc, char **argv)
{
	...
	*valCheck = 15;
	...
	Pointer<int> freeSegfaultTest(new int(13));
	Pointer<int> freeSegfaultTestCopy(freeSegfaultTest);
	...
	int i = *freeSegfaultTestCopy; // should cause a dangling pointer error message
